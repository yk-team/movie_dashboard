...
You can use custom styles from tailwind.config.js, if you need to add some custom colors, size or another, add properties inside
theme, like this, we add custome fontStyle for Tailwind
...
To learn Tailwind, check out the [TailwindDocumentation] (https://tailwindcss.com/)
